...
#
# SOLUTION for Lesson 3. Compare against your SharedProcessors/StringFormat.py.
#
...
class StringFormat(Processor):  # pylint: disable=invalid-name
    ...
    def main(self):
        ...
        # Wrap the risky call: a bad format string is a recipe authoring error,
        # so fail loudly with a ProcessorError instead of a raw traceback.
        try:
